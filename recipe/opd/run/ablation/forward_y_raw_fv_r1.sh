#!/bin/bash
# =============================================================================
# Ablation: Forward KL FV on y_raw, filtered to stage1 reward==1
# =============================================================================
# Trains on deepscaleR_stage1_responses_reward1.parquet (samples the student
# got right). Forward KL via JSD β=0.
# =============================================================================
...
echo "=========================================="
echo "ABLATION: Forward KL FV on y_raw (s1 r=1)"
echo "=========================================="
