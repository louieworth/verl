...
RUNNER_LOG_DIR="${RUNNER_LOG_DIR:-$VERL_ROOT/outputs/OPD/math/direct_variants_ms40_serial_logs_qwen3_4b_instruct}"
mkdir -p "$RUNNER_LOG_DIR"
RUNNER_LOG="$RUNNER_LOG_DIR/run_all_ms40_serial_with_eval_qwen3_4b_instruct_$(date +%Y%m%d_%H%M%S).log"

VARIANTS=(
    "direct_forward_y_o_ms40_qwen3_4b_8b.sh"
    "direct_forward_y_r_ms40_qwen3_4b_8b.sh"
...
log "Starting serial ms40 math direct variant run for Qwen3-4B-Instruct-2507"
log "TASK=$TASK"
...
log "All ms40 math direct variants completed for Qwen3-4B-Instruct-2507"
