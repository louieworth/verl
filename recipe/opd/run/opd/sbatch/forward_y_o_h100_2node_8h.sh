#!/bin/bash
#SBATCH --job-name=opd-ms40-fwd-yo-h100x8-8h
#SBATCH --partition=gpubase_bynode_b2
#SBATCH --nodes=2
#SBATCH --gres=gpu:h100:4
#SBATCH --time=08:00:00
#SBATCH --cpus-per-task=48
#SBATCH --output=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms40-fwd-yo-h100x8-8h-%j.out
#SBATCH --error=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms40-fwd-yo-h100x8-8h-%j.err
