#!/bin/bash
#SBATCH --job-name=opd-ms1-fwd-yo-h200x8-lora
#SBATCH --partition=gpubase_bynode_b2
#SBATCH --nodes=1
#SBATCH --gres=gpu:h200:8
#SBATCH --time=06:00:00
#SBATCH --cpus-per-task=64
#SBATCH --output=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms1-fwd-yo-h200x8-lora-%j.out
#SBATCH --error=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms1-fwd-yo-h200x8-lora-%j.err
