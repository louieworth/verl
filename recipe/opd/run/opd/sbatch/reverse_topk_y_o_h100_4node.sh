#!/bin/bash
#SBATCH --job-name=opd-ms40-revtopk-yo-h100x16
#SBATCH --partition=gpubase_bynode_b2
#SBATCH --nodes=4
#SBATCH --gres=gpu:h100:4
#SBATCH --time=06:00:00
#SBATCH --cpus-per-task=48
#SBATCH --output=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms40-revtopk-yo-h100x16-%j.out
#SBATCH --error=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms40-revtopk-yo-h100x16-%j.err
