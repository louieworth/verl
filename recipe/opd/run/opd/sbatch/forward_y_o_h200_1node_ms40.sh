#!/bin/bash
#SBATCH --job-name=opd-ms40-fwd-yo-h200x8
#SBATCH --partition=gpubase_bynode_b2
#SBATCH --nodes=1
#SBATCH --gres=gpu:h200:8
#SBATCH --time=04:00:00
#SBATCH --cpus-per-task=64
#SBATCH --output=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms40-fwd-yo-h200x8-%j.out
#SBATCH --error=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms40-fwd-yo-h200x8-%j.err
