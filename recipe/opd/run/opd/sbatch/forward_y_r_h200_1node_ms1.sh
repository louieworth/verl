#!/bin/bash
#SBATCH --job-name=opd-ms1-fwd-yr-h200x8
...
#SBATCH --mem=256G
#SBATCH --output=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms1-fwd-yr-h200x8-%j.out
#SBATCH --error=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms1-fwd-yr-h200x8-%j.err
