#!/bin/bash
#SBATCH --job-name=opd-ms40-revtopk-yo-h200x8-3h
#SBATCH --partition=gpubase_bynode_b1
#SBATCH --nodes=1
#SBATCH --gres=gpu:h200:8
#SBATCH --time=03:00:00
#SBATCH --cpus-per-task=64
#SBATCH --output=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms40-revtopk-yo-h200x8-3h-%j.out
#SBATCH --error=/scratch/l/luli/src/verl/recipe/opd/run/opd/sbatch/logs/opd-ms40-revtopk-yo-h200x8-3h-%j.err
