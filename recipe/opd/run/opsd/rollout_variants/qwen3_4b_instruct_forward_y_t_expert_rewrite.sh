...
# separate from the 8B student experiment.
TEACHER_TRAJECTORY_CACHE_BASE_ROOT="$VERL_ROOT/data/train_dataset/gen_y_t"
export TEACHER_TRAJECTORY_CACHE_ROOT="$TEACHER_TRAJECTORY_CACHE_BASE_ROOT/qwen3_4b_instruct_forward_y_t_qwen3_14b_x_only"
