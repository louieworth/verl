...
# separate from the 4B experiment so concurrent runs never share or overwrite it.
...
export TEACHER_TRAJECTORY_CACHE_ROOT="$TEACHER_TRAJECTORY_CACHE_BASE_ROOT/qwen3_8b_forward_y_t_qwen3_14b"
