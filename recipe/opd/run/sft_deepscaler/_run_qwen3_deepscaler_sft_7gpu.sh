...
EVAL_MAX_MODEL_LEN="${EVAL_MAX_MODEL_LEN:-$((EVAL_PROMPT_LENGTH + EVAL_RESPONSE_LENGTH))}"
EVAL_RESULTS_FILE="${EVAL_RESULTS_FILE:-$RUN_ROOT/eval/results.json}"
EVAL_OUTPUT_DIR="${EVAL_OUTPUT_DIR:-$RUN_ROOT/eval/generations}"
